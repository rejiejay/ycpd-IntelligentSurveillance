 ...
 * @param {String} networkType 支公司
 * @param {String} teamId 团队
 * @param {String} lowestMaterialfee 最低保费
 * @param {String} highestMaterialfee 最高保费
 */
export function lossAssessmentUsingGET(pageNo, pageSize, startDate, endDate, storeId, networkType, teamId, lowestMaterialfee, highestMaterialfee) {
 ...
 * @param {String} highestMaterialfee 最高保费
 */
export function exportLossAssessmentUsingGET(startDate, endDate, storeId, networkType, teamId, lowestMaterialfee, highestMaterialfee) {
    let urlparam = '';
