 ...
 */
export function listPremiumUsingGET(pageNo, pageSize, startDate, endDate, storeId, networkType, teamId, lowestSumpremium, highestSumpremium) {
 ...
 * @param {String} highestSumpremium 最高保费
 */
export function exportPremiumUsingGET(startDate, endDate, storeId, networkType, teamId, lowestSumpremium, highestSumpremium) {
    let urlparam = '';
