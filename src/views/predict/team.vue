...
// 请求类
import { queryAllTeamPredictionUsingPOST, exportTeamPredictionUsingGET, getTeamPreTemplateUsingGET, importTeamPredictionUsingFormData, getErrorTemplateUsingGET } from "@/api/predict/team";
